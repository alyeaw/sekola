...
public class pelangganView extends javax.swing.JFrame {
    ...
    void isiTabel(){
        ...
        String judul[]=("id_pelanggan","nama","alamat","notlp");
        tabelPelanggan.setModel(new DefaultTableModel(data,judul));
        jScrollPane1.setViewportView(tabelPelanggan);
    }
    
    void isiText(){
        pelanggan plg = recor.get(row);
        txtPelanggan.setText(plg.getIdPelanggan());
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNotlp, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jRadioButton1)
                                .addGap(30, 30, 30)
                                .addComponent(jRadioButton2))
                            .addComponent(txtNama, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtPelanggan, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        plg.setIdPelanggan(txtPelanggan.getText());
        plg.setNama(txtNama.getText());
        if (jRadioButton1.isSelected()){
            plg.setJeniskel(jRadioButton1.getText());
        }else{
            plg.setJeniskel(jRadioButton2.getText());
        }
